...
static bool __attribute__((unused)) pctl_read_pin(char *pin_out, size_t pin_buf_size, u32 *pin_len_out)
{
    pctl_ops_reinit();
    Service *srv = pctlGetServiceSession_Service();
...
static bool __attribute__((unused)) pinEntryScreen(const char *expected_pin, u32 pin_length)
{
